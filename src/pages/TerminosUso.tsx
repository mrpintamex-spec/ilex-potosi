...
const TerminosUso = () => (
  <div className="min-h-screen bg-background">
    <nav className="h-16 flex items-center px-5 md:px-10 bg-teal-deep border-b border-copper/20">
      <Link to="/" className="font-display font-black text-xl text-primary-foreground no-underline">
        iLEX <span className="text-copper">POTOSÍ</span>
      </Link>
    </nav>
    <main className="max-w-[720px] mx-auto px-5 py-16">
      <h1 className="font-display text-3xl font-extrabold text-teal-deep mb-6">Términos de Uso</h1>
      <div className="prose prose-sm text-foreground/80 font-display space-y-4 text-[14px] leading-[1.8]">
        <h2 className="text-lg font-bold text-teal-deep mt-8">1. Naturaleza del servicio</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">2. Uso del chatbot</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">3. Directorio de abogados</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">4. Lista Negra</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">5. Limitación de responsabilidad</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">6. Propiedad intelectual</h2>
