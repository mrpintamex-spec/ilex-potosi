...
const AvisoPrivacidad = () => (
  <div className="min-h-screen bg-background">
    ...
    <main className="max-w-[720px] mx-auto px-5 py-16">
      <h1 className="font-display text-3xl font-extrabold text-teal-deep mb-6">Aviso de Privacidad</h1>
      <div className="prose prose-sm text-foreground/80 font-display space-y-4 text-[14px] leading-[1.8]">
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">Datos que recopilamos</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">Finalidad del tratamiento</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">Protección de datos</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">Derechos ARCO</h2>
        ...
        <h2 className="text-lg font-bold text-teal-deep mt-8">Cambios al aviso</h2>
