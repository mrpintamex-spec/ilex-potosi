        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-12">
          {areas.map((area) => (
            <div
              ...
              className="reveal group bg-background rounded-2xl p-7 px-6 border border-cream-dark cursor-pointer relative overflow-hidden transition-all hover:-translate-y-1 hover:shadow-ilex-md hover:bg-card"
            >
              ...
              <h3 className="font-display text-[15px] font-bold text-teal-deep mb-2">{area.title}</h3>
              <p className="text-[12.5px] text-foreground/70 leading-relaxed">{area.desc}</p>
